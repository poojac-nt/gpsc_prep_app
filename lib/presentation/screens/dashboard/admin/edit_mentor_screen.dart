...
class _EditMentorScreenState extends State<EditMentorScreen> {
  ...
  void initState() {
    ...
    _specializations = widget.mentor.subjects.map((s) => s.subjectName).toList();
    _isActive = true;
  }
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: CustomTextField(
          ...
          hintText: 'e.g. Quantitative Aptitude',
        ),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () {
              ...
              if (tag.isNotEmpty && !_specializations.contains(tag)) {
                setState(() => _specializations.add(tag));
              }
              Navigator.pop(ctx);
            },
            child: Text(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              if (id != null) {
                context.read<AdminBloc>().add(DeleteMentor(id));
              }
            },
            child: Text(
              'Delete',
